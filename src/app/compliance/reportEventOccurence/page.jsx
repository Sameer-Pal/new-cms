...
{/* Main Search Section */}
<div className=" mt-6 m-4 p-4 border border-gray-300 bg-[#d4d4d4] rounded-lg"> 
  {/* min-h-screen add krra hia yaha pe  */}
   <div className="flex flex-col sm:flex-row justify-between items-center">
    ...
    <div className='flex w-full sm:w-auto flex-col sm:flex-row sm:items-center'>
      ...
      <button
        ...
        className="mb-2 sm:mb-0 sm:ml-2 px-4 py-2 bg-blue-600 text-white rounded-md shadow-md hover:bg-blue-700 transition duration-200 whitespace-nowrap"
      >
        Search
      </button>
    ...
    <label htmlFor="unmappedOnly" className="ml-2 block text-sm text-gray-700">
      Show Only Unmapped Compliances
            ...
            <div className="mt-6 flex justify-end">
              <button
                onClick={handleReset}
                className="mr-4 px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover: bg-[#F5F5F5]"
              >
                Reset
              </button>
              <button
