...
const FutureArchievedDeleted = () => {
    ...
    const [radioParams, setRadioParams] = useState({
        viewOption: 'future', // default option
        normalSearchTerm: '',
      });
   ...
   const handleRadioChange = (e) => {
    ...
    const paths = [
      ...
      { label: "Future/Archieved/Deleted", link: "/compliance/create-edit-search" },
    ];
...
export default FutureArchievedDeleted