...
{/* Main Search Section */}
<div className="mt-6 m-4 p-4 border border-gray-300 bg-gray-10 rounded-lg"> 
            ...
            <div className="grid grid-cols-2 md:grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className="mt-1 block w-full max-w-full px-2 py-2 border border-gray-300 bg-gray-800 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                  >
