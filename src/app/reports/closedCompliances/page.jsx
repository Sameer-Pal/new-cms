...
export default function OpenClosedCompliances() {
  ...
  const [radioParams, setRadioParams] = useState({
    viewOption: "pending", // Default status (Pending)
  });

  // Handle changes for radio button options
  ...
  // Handle input change for search and other filters
  ...
  // Open the modal for advanced search
  const handleOpenModal = () => {
    setIsModalOpen(true);
  };

  // Close the modal for advanced search
  ...
  const paths = [
    ...
    { label: "Pending/Closed/In Progress", link: "/compliance/search" },
  ];
  ...
  return (
    <>
      ...
      <div className="min-h-screen text-white p-4 m-2 border border bg-[#FFFFFF] rounded-xl">
        ...
        <div className="mb-6 p-4 border border-gray-500 rounded-md bg-[#F5F5F5]">
  <div className="mt-2 flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-4 sm:space-y-0 ">
    {/* Radio buttons for compliance status */}
    <div className="flex flex-col sm:flex-row items-start sm:items-center md:flex space-y-2 sm:space-y-0 sm:space-x-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="flex items-center space-x-2">
        ...
        <input
          ...
          className="px-3 py-2 w-full border border-gray-300 rounded-md shadow-xl focus:ring-indigo-500 focus:border-indigo-500 text-sm bg-white"
        />
      </div>
      <div className="flex items-center lg:space-x-2 space-x-7">
        ...
        {isModalOpen && (
          ...
          <div className="bg-white rounded-lg shadow-lg max-w-4xl w-full mx-4 sm:mx-8 p-6 relative">
            ...
            <h2 className="text-lg text-black font-semibold mb-4">Compliance Search</h2>
